...
public class MainActivity9 extends AppCompatActivity
{
    ...
    public void mainMenuStart(View view)
    {
       try{thread.interrupt();}catch(Exception e){}
        ...
        Intent mainMenuIntent = new Intent(MainActivity9.this, StartMenu.class);
    ...
    public void levelTenStart(View view)
    {
        ...
        try{runAnimation.stop();}catch(Exception e){}
        try{jumpAnimation.stop();}catch(Exception e){}
        Intent levelTenIntent = new Intent(MainActivity9.this, MainActivity10.class);
        startActivity(levelTenIntent);
    }
