...
public class MainActivity13 extends AppCompatActivity
{
    ...
    public void mainMenuStart(View view)
    {
       try{thread.interrupt();}catch(Exception e){}
        ...
        Intent mainMenuIntent = new Intent(MainActivity13.this, StartMenu.class);
    ...
    public void levelFourteenStart(View view)
    {
        ...
        try{runAnimation.stop();}catch(Exception e){}
        try{jumpAnimation.stop();}catch(Exception e){}
        Intent levelFourteenIntent = new Intent(MainActivity13.this, MainActivity14.class);
        startActivity(levelFourteenIntent);
    }
