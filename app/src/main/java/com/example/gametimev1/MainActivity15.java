...
public class MainActivity15 extends AppCompatActivity
{
    ...
    public void mainMenuStart(View view)
    {
       try{thread.interrupt();}catch(Exception e){}
        ...
        Intent mainMenuIntent = new Intent(MainActivity15.this, StartMenu.class);
    ...
    public void levelSixteenStart(View view)
    {
        ...
        try{runAnimation.stop();}catch(Exception e){}
        try{jumpAnimation.stop();}catch(Exception e){}
        Intent levelSixteenIntent = new Intent(MainActivity15.this, MainActivity16.class);
        startActivity(levelSixteenIntent);
    }
