...
{
    ImageView heroIdle,heroJump,heroRun,coin1,coin2,coin3,tint,collected1,collected2,collected3,rockSpike1;
    FrameLayout frame;
    TextView story;
    ...
    Rect heroRect,coin1Rect,coin2Rect,coin3Rect,rockSpike1Rect;
    ...
    public void mainMenuStart(View view)
    {
       try{thread.interrupt();}catch(Exception e){}
        ...
        Intent mainMenuIntent = new Intent(MainActivity5.this, StartMenu.class);
    ...
    public void levelSixStart(View view)
    {
        ...
        try{runAnimation.stop();}catch(Exception e){}
        try{jumpAnimation.stop();}catch(Exception e){}
       Intent levelSixIntent = new Intent(MainActivity5.this, MainActivity6.class);
    ...
    public void collectionTime()
    {
        ...
        rockSpike1Rect = new Rect((int)(rockSpike1.getX()/density), (int)(rockSpike1.getY()/density), (int)((rockSpike1.getX() + rockSpike1.getWidth())/density), (int)((rockSpike1.getY() + rockSpike1.getHeight())/density));
            ...
            if(Rect.intersects(heroRect,rockSpike1Rect))
            {
                alive = false;
                deathScreen();
            }
...
class Platforms5 extends AppCompatActivity
{
    ImageView id;

    public Platforms5(ImageView iD)
    {
        id = iD;
    }
...
class Ground5 //extends MainActivity
{
    public boolean onGround(boolean verticalPressed, float heroJumpY,  float heroJumpX, ImageView heroJump, FrameLayout frame, ArrayList<Platforms5> platforms)
    {
        if(heroJumpY == frame.getHeight() - heroJump.getHeight() - 56)
            return true;
