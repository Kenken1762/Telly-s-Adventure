...
public class MainActivity12 extends AppCompatActivity
{
    ...
    public void mainMenuStart(View view)
    {
       try{thread.interrupt();}catch(Exception e){}
        ...
        Intent mainMenuIntent = new Intent(MainActivity12.this, StartMenu.class);
    ...
    public void levelThirteenStart(View view)
    {
        ...
        try{runAnimation.stop();}catch(Exception e){}
        try{jumpAnimation.stop();}catch(Exception e){}
        Intent levelThirteenIntent = new Intent(MainActivity12.this, MainActivity13.class);
        startActivity(levelThirteenIntent);
    }
