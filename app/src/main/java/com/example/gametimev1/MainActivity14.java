...
public class MainActivity14 extends AppCompatActivity
{
    ...
    public void mainMenuStart(View view)
    {
       try{thread.interrupt();}catch(Exception e){}
        ...
        Intent mainMenuIntent = new Intent(MainActivity14.this, StartMenu.class);
    ...
    public void levelFifteenStart(View view)
    {
        ...
        try{runAnimation.stop();}catch(Exception e){}
        try{jumpAnimation.stop();}catch(Exception e){}
        Intent levelFifteenIntent = new Intent(MainActivity14.this, MainActivity15.class);
        startActivity(levelFifteenIntent);
    }
