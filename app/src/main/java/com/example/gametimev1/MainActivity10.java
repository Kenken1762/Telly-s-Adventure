...
public class MainActivity10 extends AppCompatActivity
{
    ...
    public void mainMenuStart(View view)
    {
       try{thread.interrupt();}catch(Exception e){}
        ...
        Intent mainMenuIntent = new Intent(MainActivity10.this, StartMenu.class);
    ...
    public void levelElevenStart(View view)
    {
        ...
        try{runAnimation.stop();}catch(Exception e){}
        try{jumpAnimation.stop();}catch(Exception e){}
        Intent levelElevenIntent = new Intent(MainActivity10.this, MainActivity11.class);
        startActivity(levelElevenIntent);
    }
