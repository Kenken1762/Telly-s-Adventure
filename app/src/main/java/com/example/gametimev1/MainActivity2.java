...
public class MainActivity2 extends AppCompatActivity
{
    ...
    upButton = findViewById(R.id.upButton);
        upButton.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if(motionEvent.getAction() == motionEvent.ACTION_DOWN && !actionDown )
                {
                        jump = new Thread(){
                            public void run(){
    ...
    public void mainMenuStart(View view)
    {
       try{thread.interrupt();}catch(Exception e){}
        ...
        Intent mainMenuIntent = new Intent(MainActivity2.this, StartMenu.class);
    ...
    public void levelThreeStart(View view)
    {
        ...
        try{runAnimation.stop();}catch(Exception e){}
        try{jumpAnimation.stop();}catch(Exception e){}
        Intent levelThreeIntent = new Intent(MainActivity2.this, MainActivity3.class);
