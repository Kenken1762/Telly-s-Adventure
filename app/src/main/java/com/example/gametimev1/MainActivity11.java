...
public class MainActivity11 extends AppCompatActivity
{
    ...
    public void mainMenuStart(View view)
    {
       try{thread.interrupt();}catch(Exception e){}
        ...
        Intent mainMenuIntent = new Intent(MainActivity11.this, StartMenu.class);
    ...
    public void levelTwelveStart(View view)
    {
        ...
        try{runAnimation.stop();}catch(Exception e){}
        try{jumpAnimation.stop();}catch(Exception e){}
        Intent levelTwelveIntent = new Intent(MainActivity11.this, MainActivity12.class);
        startActivity(levelTwelveIntent);
    }
