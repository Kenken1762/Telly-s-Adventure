...
public class MainActivity6 extends AppCompatActivity
{
    ...
    public void mainMenuStart(View view)
    {
       try{thread.interrupt();}catch(Exception e){}
        ...
        Intent mainMenuIntent = new Intent(MainActivity6.this, StartMenu.class);
    ...
    public void levelSevenStart(View view)
    {
        ...
        try{runAnimation.stop();}catch(Exception e){}
        try{jumpAnimation.stop();}catch(Exception e){}
        Intent levelSevenIntent = new Intent(MainActivity6.this, MainActivity7.class);
        startActivity(levelSevenIntent);
    }
