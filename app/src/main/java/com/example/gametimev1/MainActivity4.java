...
{
    ImageView heroIdle,heroJump,heroRun,coin1,coin2,coin3,tint,collected1,collected2,collected3,rockSpike1,rockSpike2,rockSpike3,rockSpike4;
    FrameLayout frame;
    TextView story;
    ...
    Rect heroRect,coin1Rect,coin2Rect,coin3Rect,rockSpike1Rect,rockSpike2Rect,rockSpike3Rect,rockSpike4Rect;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        rockSpike3 = findViewById(R.id.rockspike3);
        rockSpike4 = findViewById(R.id.rockspike4);
        ...
        for(int x = 0;x < 2;x++)
        {
            ...
            platforms.add(new Platforms(findViewById(sourceID)));
        }
    }
    ...
    public void mainMenuStart(View view)
    {
       try{thread.interrupt();}catch(Exception e){}
        ...
        Intent mainMenuIntent = new Intent(MainActivity4.this, StartMenu.class);
    ...
    public void levelFiveStart(View view)
    {
        ...
        try{runAnimation.stop();}catch(Exception e){}
        try{jumpAnimation.stop();}catch(Exception e){}
        Intent levelFiveIntent = new Intent(MainActivity4.this, MainActivity5.class);
    ...
    public void collectionTime()
    {
        ...
        rockSpike3Rect = new Rect((int)(rockSpike3.getX()/density), (int)(rockSpike3.getY()/density), (int)((rockSpike3.getX() + rockSpike3.getWidth())/density), (int)((rockSpike3.getY() + rockSpike3.getHeight())/density));
        rockSpike4Rect = new Rect((int)(rockSpike4.getX()/density), (int)(rockSpike4.getY()/density), (int)((rockSpike4.getX() + rockSpike4.getWidth())/density), (int)((rockSpike4.getY() + rockSpike4.getHeight())/density));
            ...
            if(Rect.intersects(heroRect,rockSpike1Rect) || Rect.intersects(heroRect,rockSpike2Rect)
                    || Rect.intersects(heroRect,rockSpike3Rect) || Rect.intersects(heroRect, rockSpike4Rect))
            {
                alive = false;
                deathScreen();
            }
    ...
    public void verticalLimiter() {
        ...
        //Ground
        if (heroIdleY > frame.getHeight() - heroIdle.getHeight() - 80){
            heroIdleY = frame.getHeight() - heroIdle.getHeight() - 81;
            heroJumpY = frame.getHeight() - heroJump.getHeight() - 81;
            heroRunY = frame.getHeight() - heroRun.getHeight() - 81;
    }
