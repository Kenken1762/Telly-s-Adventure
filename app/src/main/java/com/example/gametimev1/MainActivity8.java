...
public class MainActivity8 extends AppCompatActivity
{
    ...
    public void mainMenuStart(View view)
    {
       try{thread.interrupt();}catch(Exception e){}
        ...
        Intent mainMenuIntent = new Intent(MainActivity8.this, StartMenu.class);
    ...
    public void levelNineStart(View view)
    {
        ...
        try{runAnimation.stop();}catch(Exception e){}
        try{jumpAnimation.stop();}catch(Exception e){}
        Intent levelNineIntent = new Intent(MainActivity8.this, MainActivity9.class);
        startActivity(levelNineIntent);
    }
