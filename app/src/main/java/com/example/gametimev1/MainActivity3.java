...
{
    ImageView heroIdle,heroJump,heroRun,coin1,coin2,coin3,tint,collected1,collected2,collected3,rockSpike1,rockSpike2,rockSpike3;
    FrameLayout frame;
    TextView story;
    ...
    Rect heroRect,coin1Rect,coin2Rect,coin3Rect,rockSpike1Rect,rockSpike2Rect,rockSpike3Rect;
    ...
    public void mainMenuStart(View view)
    {
       try{thread.interrupt();}catch(Exception e){}
        ...
        Intent mainMenuIntent = new Intent(MainActivity3.this, StartMenu.class);
    ...
    public void levelFourStart(View view)
    {
        ...
        try{runAnimation.stop();}catch(Exception e){}
        try{jumpAnimation.stop();}catch(Exception e){}
       Intent levelFourIntent = new Intent(MainActivity3.this, MainActivity4.class);
    ...
    public void collectionTime()
    {
        ...
        rockSpike3Rect = new Rect((int)(rockSpike3.getX()/density), (int)(rockSpike3.getY()/density), (int)((rockSpike3.getX() + rockSpike3.getWidth())/density), (int)((rockSpike3.getY() + rockSpike3.getHeight())/density));
            ...
            if(Rect.intersects(heroRect,rockSpike1Rect) || Rect.intersects(heroRect,rockSpike2Rect) || Rect.intersects(heroRect,rockSpike3Rect))
            {
                alive = false;
                deathScreen();
            }
